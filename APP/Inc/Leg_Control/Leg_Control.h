...
typedef enum
{
  ...
  Motor_Control_TrajectoryDryRun = 7,
  Motor_Control_TrajectoryActive = 8
...
typedef enum
{
  ...
  Motor_Control_Reason_TrajectoryComplete = 9
...
void Leg_Control_GetLegTrajectorySnapshot(Motor_LegTrajectorySnapshot *snapshot);
